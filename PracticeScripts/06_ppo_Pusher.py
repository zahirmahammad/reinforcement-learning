...
class Pusher_PPO:
    def __init__(self):
        ...
        self.eval_env = gym.make("Pusher-v5", render_mode='rgb_array')
    ...
    def TestAgent(self, num_eval_episodes):
        ...
        imageio.mimsave(f"media/06_ppo_Pusher.gif", frames, fps=30, loop=True)

if __name__ == "__main__":
    pusher = Pusher_PPO()
    # pusher.TakeRandomActions()
    pusher.TrainAgent()
    pusher.TestAgent(num_eval_episodes=10)